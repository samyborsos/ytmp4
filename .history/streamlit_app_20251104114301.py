...
if url.strip():
    try:
        ...
        if st.button("Download"):
            ...
            def progress_hook(d):
                nonlocal last_update, speed_history
                if d['status'] == 'downloading':
                    now = time.time()
                    # Update at most every 0.2 seconds
                    ...
                    if total_bytes:
                        ...
                        # Use moving average speed to smooth ETA
                        ...
                        status_text.text(f"Downloading... {percent*100:.1f}% | ETA: {int(eta)}s")
