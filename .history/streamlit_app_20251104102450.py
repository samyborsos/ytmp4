...
st.title("YouTube Downloader (Auto-select best format)")
...
if url.strip():
    try:
        ...
        # Extract best video+audio and best audio-only
        best_video = None
        best_audio = None
        ...
        # User chooses download type
        choice = st.radio("Download type:", ["Video", "Audio"])
